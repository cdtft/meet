 ...
 */
public class NoticePO2ArticlesRespVO implements Function<NoticePO, ArticlesRespVO> {

    @Nullable
    @Override
    public ArticlesRespVO apply(@Nullable NoticePO po) {
        if (po != null) {
            ...
            vo.setType(ArticleEnum.NOTICE.getType());
            return vo;
        }
        return null;
    }

 ...
 */
public class NewsPO2ArticlesRespVO implements Function<NewsPO, ArticlesRespVO> {

    @Nullable
    @Override
    public ArticlesRespVO apply(@Nullable NewsPO po) {
        ...
        if (po != null) {
            ...
            vo.setType(ArticleEnum.NEWS.getType());
            return vo;
        }
        return null;
    }
